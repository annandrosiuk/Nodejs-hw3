...
export default function UserInfo(props) {
    ...
    return (
        <div className='block user__profile'>
                ...
                <div className="user__wrapper">
                    ...
                    <div className='user__info'>
                        ...
                        <div className="user__panel">
                            <button className="user__button" type='button' onClick={toggleShowUserUpdateForm}>
                                {showUserUpdateForm
                            ...
                            <button className="user__button" type='button' onClick={toggleShowPasswordUpdateForm}>
                            ...
                            <button className="user__button" type='button' onClick={handleLogout}> Log out </button>

                            {user.role === 'shipper' &&
                                <button className="user__button" type='button' onClick={deleteAccount}> Delete Account </button>
                            }
                        </div>
                    </div>
                </div>
